...
@XmlType(name = "PremisesType", propOrder = {
    "nameElementOrNumber"
})
@XmlSeeAlso({
    oasis.names.tc.ciq.xal._3.AddressType.Premises.SubPremises.class,
    oasis.names.tc.ciq.xal._3.AddressType.Premises.class
})
