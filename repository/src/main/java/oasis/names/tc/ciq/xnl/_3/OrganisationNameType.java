 ...
 *       &lt;attribute name="OrganisationType" type="{urn:oasis:names:tc:ciq:xnl:3}OrganisationNameTypeList" />
...
public class OrganisationNameType {
    ...
    @XmlAttribute(name = "OrganisationType", namespace = "urn:oasis:names:tc:ciq:xnl:3")
    protected OrganisationNameTypeList organisationType;
     ...
     *     
     */
    public OrganisationNameTypeList getOrganisationType() {
     ...
     *     
     */
    public void setOrganisationType(OrganisationNameTypeList value) {
