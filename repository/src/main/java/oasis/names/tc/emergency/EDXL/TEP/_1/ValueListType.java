 ...
 *         &lt;element ref="{urn:oasis:names:tc:emergency:edxl:ct:1.0}Value" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ValueListType", namespace = "urn:oasis:names:tc:emergency:edxl:ct:1.0", propOrder = {
    "valueListURI",
    "value"
})
